...
@configclass
class L2DualPushEnvCfg(AionGenosReachEnvBaseCfg):
    """Environment configuration for the L2 Dual Push task (utilizing Pose/RPY control)."""
    ...
    def __post_init__(self):
        ...
        # Configure action controllers to use Differential IK (Pose-level for RPY)
