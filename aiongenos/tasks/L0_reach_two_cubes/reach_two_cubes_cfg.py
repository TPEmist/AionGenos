...
@configclass
class L0ReachTwoCubesEnvCfg(AionGenosReachEnvBaseCfg):
    """Environment configuration for the L0 Reach Two Cubes task."""
    ...
    def __post_init__(self):
        ...
        self.scene.num_envs = 1  # Standard for VLM cognitive rollout
