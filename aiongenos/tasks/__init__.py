...
# WP1 (Paper 2) registrations live in a SEPARATE module (wp1_registry.py) —
# this file is intermittently rewritten by the IDE language server, which
# silently clobbered inline WP1 registers mid-bisection (2026-08-05, 4th
# shared-resource incident → isolate, don't share). One import line is easy
# to re-verify; an inline block clobber was invisible.
from . import wp1_registry  # noqa: E402,F401
